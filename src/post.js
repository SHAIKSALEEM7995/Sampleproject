...
let Postpage=()=>{
    ...
    const Postsometext=async(e)=>{
          ...
          await axios.post("http://localhost:8080/postdata/postdataa",mydata);
            ...
            <div class="container2">
                    ...
                    <div class="mainpostdiv">
                          <div id="mainpostdivprofile">
                             ...
                             <textarea id="posttextarea" rows="15" cols="80" onChange={e=>setName(e.target.value)} maxlength="250">Write Something here and POST it...!</textarea>
                             <button id="postbutton" onClick={Postsometext}>Post</button>
